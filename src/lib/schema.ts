...
export const interviewSchema = z.object({
  ...
  category: z.string(), interview_date: z.string().nullable(), summary: z.string(), tags: z.array(z.string()),
...
export const snapshotSchema = z.object({
  schema_version: z.literal(1), build_id: z.string(), built_at: z.string(), demo: z.boolean(),
...
export type Filters = { company?: string; category?: string; tag?: string };
...
export const searchRequestSchema = z.object({
  ...
  filters: z.object({ company: z.string().max(200).optional(), category: z.string().max(100).optional(), tag: z.string().max(100).optional() }).strict().optional(),
