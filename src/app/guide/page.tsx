...
const steps = [
  {
    icon: FilePlus2,
    title: "01 / 粘贴并保存原文",
    text: "管理员登录后打开面经管理，把完整面经粘贴到输入框。提交后原文会保存在 服务器资料目录，不要求固定模板，整理成功后访客可查看完整原文。",
  },
  {
    icon: Sparkles,
    title: "02 / 自动整理",
  ...
  },
  {
    icon: Trash2,
    title: "04 / 管理与删除",
    text: "在面经管理页可以删除自己粘贴的面经；删除后原文和搜索索引同步更新。内置示例受到保护。也可以直接维护 DATA_DIR/raw 中的文件，再运行数据构建命令。",
  },
];
...
export default function Guide() {
  return <Shell><div className="mx-auto max-w-3xl">
    ...
    <p className="mb-6 text-sm leading-7 text-stone-500">保留面试原文，让总结和搜索帮助你回顾关键问题。访客可自由阅读和搜索；新增、删除和整理仅限管理员。</p>
